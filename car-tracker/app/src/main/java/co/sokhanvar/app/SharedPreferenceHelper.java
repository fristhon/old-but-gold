...
/**
 * Created by MRJ on 31/01/2018.
 */

public class SharedPreferenceHelper {

  public final String PREF_FILE = "PREF";
   ...
   */
  public void setSharedPreferenceString(
    Context context,
    String key,
    String value
  ) {
   ...
   * @param value - Value for the key
   */
  public void setSharedPreferenceBoolean(
    Context context,
    String key,
    boolean value
  ) {
   ...
   * @return value - String containing value of the shared preference if found.
   */
  public boolean getSharedPreferenceBoolean(
    Context context,
    String key,
    boolean defValue
  ) {
